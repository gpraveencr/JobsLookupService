  ...
  <script>
    Ext.onReady(function() {
      ...
      var store = new Ext.data.Store({
        url: '/JobsLookupService/rest/jobs',
      ...
      var grid = new Ext.grid.EditorGridPanel({
        ...
        listeners: {
          afteredit: function(e) {
            ...
            var restURL = '/JobsLookupService/rest/job/' + _ticker;
            ...
            text:'Add Issuer',
                ...
                handler: function() {
                  var form = new Ext.form.FormPanel({
                    ...
                    labelWidth: 75,
                    name: 'MyForm',
                    url: '/JobsLookupService/rest/job',
                  ...
                  if (sm.hasSelection()) {
                    Ext.Msg.show({
                      ...
                      fn: function(btn) {
                        if (btn == 'yes') {
                          var conn = new Ext.data.Connection();
                          var restURL = '/JobsLookupService/rest/job/' + sel.data.ticker;
                          conn.request({
                            method: 'DELETE',
                            url: restURL,
